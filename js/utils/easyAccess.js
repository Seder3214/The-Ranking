...
function gridTierUpCost(layer, id) {
	return (gridRun(layer, 'tierUpCost', player[layer].grid[id], id))
}
function gridTetrUpCost(layer, id) {
	return (gridRun(layer, 'tetrUpCost', player[layer].grid[id], id))
}
function gridPentUpCost(layer, id) {
	return (gridRun(layer, 'pentUpCost', player[layer].grid[id], id))
}
function gridHexUpCost(layer, id) {
	return (gridRun(layer, 'hexUpCost', player[layer].grid[id], id))
}
function gridHexUpChance(layer, id) {
	return (gridRun(layer, 'hexUpChance', player[layer].grid[id], id))
}
